...
-- ===================================================================
-- STEP 1: Materialize all touches joined
-- This is the expensive build, but it happens exactly once
-- ===================================================================
...
-- winback_floor = most recent prior CANCEL; upgrade_floor = most recent prior START.
prior_floor AS (
  SELECT curr.sub_id,
