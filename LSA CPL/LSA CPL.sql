Select s.customerID, #c.officeID,
case
    ...
    #Count(if(c.sale_billable="billable", true, false)) as Leads
...
#left join dwh_ctmdb.calls as c on c.officeID = d.officeID
WHERE year(s.dbDate) = "2023" and month(s.dbDate) = "09" and s.customerID != '6850114974' #eliminate Google Ads from results
group by 
	Branch
Order by
	Branch asc