...
joinder as (
SELECT b1.tag as 'b1Tag', b1.call_id as 'b1callId', customer.tag as 'cTag', customer.call_id as 'cCallId', c.call_id, sale_billable, called_at, note, contact_number_clean,
...
select j.b1Tag, j.call_id, j.called_at, j.note, j.isCustomer, j.correctBillable, j.contact_number_clean, c.phone1, (correctBillable = 0 and phone1 is not null) as currentCustomer, count(j.correctBillable) 
from joinder as j
