select 
	count(ca.call_id) "Calls", ca.source "Source", o.branchName "Branch", s.serviceType "Service", 
	month(ca.dateContacted) "Month", year(ca.dateContacted) "Year"
...
group by ca.source, ca.officeID, s.serviceType, month(ca.dateContacted)
