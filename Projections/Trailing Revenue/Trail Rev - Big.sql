...
/* 2.282 Run; 33.640 Fetch
create temporary table
#*/ with
calls as ( -- Use unfiltered calls because later we will connect these to subscriptions by phone number, which should eliminate subscriptions that were not won by IM efforts
...
/* 4.266 Run; 0.000 Fetch;
;create temporary table
#*/, 
roi as ( -- All this is doing is associating spend with a specific year
select 
	case 
        ...
        when year(called_at_denver) = 2023 then 
											5435658 
                                            -- 5548772.57
